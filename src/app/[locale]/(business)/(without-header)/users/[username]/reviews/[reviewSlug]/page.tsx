...
import ReviewJsonLd from "@/app/[locale]/(business)/(without-header)/users/[username]/reviews/[reviewSlug]/json-ld";
            ...
            <div className="flex flex-col gap-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                  ...
                  <DescriptionList
                    ...
                    value={
                      <ReviewFieldValue
                        ...
                        possibleValues={
                          labelDesignValues as unknown as string[]
                        }
                      />
                    }
                    className={cn(
                ...
                {review.headRetention ? (
                  <DescriptionList
                    label={t(
                      "reviewPage.appearance.fields.headRetention.label",
                    )}
                    value={
                      <ReviewFieldValue
                        label={t(
                  ...
                  <DescriptionList
                    ...
                    value={
                      <ReviewFieldValue
                        ...
                        possibleValues={
                          bodyStrengthValues as unknown as string[]
                        }
                      />
                    }
                    className="*:data-[slot=description-details]:gap-x-paragraph-space *:data-[slot=description-details]:flex *:data-[slot=description-details]:flex-row *:data-[slot=description-details]:items-baseline"
