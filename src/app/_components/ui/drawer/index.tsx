  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-background fixed z-50 flex h-auto flex-col gap-y-6 border-2 p-8",
        ...
        {...restProps}
      >
        <div className="bg-foreground absolute top-3 left-1/2 hidden h-[3px] w-16 -translate-x-1/2 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
...
const DrawerHeader = ({ className, ...restProps }: ComponentProps<"div">) => {
  return (
    <div
...
const DrawerFooter = ({ className, ...restProps }: ComponentProps<"div">) => {
  return (
    <div
